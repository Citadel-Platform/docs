...
## Definition of done
- [ ] ARM appears in central product navigation
- [ ] Citadel apps can report internal UI failures through ARM
- [ ] Aggregate reporting boundaries are documented
- [ ] Intake gateway is either deferred with rationale or specified
