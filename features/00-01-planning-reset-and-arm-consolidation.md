...
## Definition of done
- [ ] Active docs no longer describe the old example project as current state
- [ ] ARM code exists under `citadel_core/arm/tooling` and `citadel_core/arm/console`
- [ ] Consolidated ARM packages have validation status recorded
- [ ] Any package renaming decision is recorded before implementation
